...
RULES: tuple[Rule, ...] = (
    Rule(
        ...
        reply=(
            ...
            "如果你想了解**自己**的薪酬构成，可以找 HRBP 王倩（企业微信 @王倩）。"
        ),
        referral="HRBP 王倩",
    ),
    Rule(
        ...
        reply=(
            ...
            "如果是你自己的绩效结果或职级问题，可以找 HRBP 王倩（企业微信 @王倩）。"
        ),
        referral="HRBP 王倩",
    ),
    Rule(
        ...
        reply=(
            ...
            "请直接联系 HRBP 王倩（企业微信 @王倩）；如果你希望绕开直属线，"
            "公司合规邮箱是 compliance@yunqi.example，独立于业务汇报线。"
        ),
        referral="HRBP 王倩 / 合规邮箱",
    ),
    Rule(
        id="H3-04",
        name="代签署文件",
